...
const SYSTEM = [
  ...
  '- Prefer findings that stay close to what a voice actually said. When a similar concern',
  '  appears in more than one unit, you may surface it and cite those units, but report it as',
  '  what was said — not as a single theme you have constructed across them.',
  '',
